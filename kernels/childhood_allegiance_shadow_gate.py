"""
Aureon / OpenHermes Kernel – “Childhood Allegiance – Shadow Gate” Module

This module encodes a three-stage transformation path inspired by Doshema’s poem
“Childhood Allegiance”. It is designed as a gentle shadow-integration helper
...
2. Make the Line Visible
   ...
   - Surface “blood contracts” and hidden bargains the system has been carrying.
...
@dataclass
class IdentityState:
    """Container for the Childhood Blood Allegiance – Shadow Gate process state."""
    raw_text: str = ""
...
def detect_shadow_oaths(state: IdentityState) -> IdentityState:
    """Heuristically detect “shadow oath” language in the raw narrative text."""
