"""
Aureon / OpenHermes Kernel â€” â€œThe Fourth Circleâ€ Burden & Rotation Kernel

Inspired by Doshemaâ€™s poem â€œThe Fourth Circleâ€ from Beyond the Sphere of Destiny.
...
The â€œFourth Circleâ€ here is treated as:
...
1. Name the Orbit
   ...
   - Identify the â€œmassâ€ that keeps the system circling: money, guilt, loyalty,
...
3. Break the Spin-Contract
   - Surface and symbolically dissolve the tacit contract that keeps the orbit going:
     â€œI must keep paying,â€ â€œI cannot stop,â€ â€œI owe them forever,â€ etc.
