# Aureon / OpenHermes Kernel – “Viscera” Innocence & Trauma Decoder Module

This module implements a perception-filter based on Doshema's poem “Viscera”.
It treats all human behavior as originating in an underlying child–state and
tries to:
...
“Picture ALL human beings as children… disguised as adults, in illusory Time
fashioned costumes of lost innocence.”
...
class InnocenceSignal:
    ...
    child_voice_score:
        ...
        (simple language, “no one loves me,” “it's not fair,” etc.).
    dissociation_score:
    ...
    def compassion_priority(self) -> float:
        ...
        """
        # Soft weighting – we want high priority when there is pain
...
class ReframedMeaning:
    ...
    of “all humans are children wearing adult costumes”.
...
def reframe_utterance(text: str, signal: InnocenceSignal) -> ReframedMeaning:
    ...
    pain_story = (
        ...
        "to manage overwhelming feelings with whatever strategies they inherited – "
...
def analyze_utterance(text: str) -> VisceraAnalysis:
    """
    Main entrypoint: given an utterance, produce a full “Viscera-informed”
