"""
Aureon / OpenHermes Kernel — “The Fruitless Season” Fallow Field Kernel

Inspired by Doshema’s “The Fruitless Season” from Beyond the Sphere of Destiny.
This kernel encodes the experience of apparent barrenness — when nothing seems
to grow despite effort — and reframes it as a fallow, regenerative interval
...
4. Hint the Next Sowing
   - Offer a minimal, non-violent next step: a tiny seed action, not a
     forced new harvest.
   - Encode a “Fallow Vow” about how the system will treat itself in seasons
...
def hint_next_sowing(state: FruitlessSeasonState) -> FruitlessSeasonState:
    ...
    if exhaustion == "high":
        ...
        state.next_sowing_hint = (
            "Choose one simple seed — a conversation, a page, a gesture — and plant it "
    ...
    state.fallow_vow = (
        ...
        "as fallow fields — for rest, root-work, and quiet preparation — until it is time to sow again."
    )
